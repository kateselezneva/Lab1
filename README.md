...
На вход программа должна получать 5 чисел, при этом в условии сказано, что числа натуральные. Максимальное значение условием не определено, возьмем 10<sup>9</sup> для каждой переменной.

|             | Тип                | min значение | max значение |
|-------------|--------------------|--------------|--------------|
| X (Число 1) | Вещественное число | 1            |10<sup>9</sup>|
| A (Число 2) | Вещественное число | 1            |10<sup>9</sup>|
| B (Число 3) | Вещественное число | 1            |10<sup>9</sup>|
| C (Число 4) | Вещественное число | 1            |10<sup>9</sup>|
| D (Число 5) | Вещественное число | 1            |10<sup>9</sup>|


#### Данные на выход

Т.к. программа должна вывести количество упавших доминошек, то на выход мы получим
единственное натуральное число, не превышающее 5 (т.к. доминошек всего 5).
