...
| D (Число 5) | Вещественное число | 0            |              |
...
2. **Сравнение расстояний между доминошками и их высоты:**  
   ...
   4) Программа сравнивает значения `x` и `a`. Если `x` больше `a`, то 3-ая доминошка заденет 2-ую, программа переходит
      к следующему сравнению. Если `a` больше или равно `x`, упадут 3-я, 4-ая и 5-ая доминошки, программа выводит 3 и заканчивает работу.
